...
> **⚠️ DEMO REPOSITORY — This is a read-only structural preview. The full source code, all modules, complete test suite, and documentation are available in the full version below.**
>
